...
expert_buffer = Mujoco_Dset(env, 'demo_collection/Bipedal_size50000_std0.01_prand0.0.pth', 50000)
state_shape = env.observation_space.shape
action_shape = env.action_space.shape
...
p_rand = 0.1      # Probability of random action, adjust as needed

demo_buffer = collect_demo(env, td3_policy, buffer_size=demo_buffer_size, device=device, std=demo_std, p_rand=p_rand)
output_demo_path = f"demo_collection/DAC_aug_buffer_size_{demo_buffer_size}.pth"
